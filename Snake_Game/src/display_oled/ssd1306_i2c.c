...
RenderArea ssd1306_init() {
    ...
    RenderArea render_area = get_render_area();
    calculate_render_area_buffer_length(&render_area);
    return render_area;
}
...
void ssd1306_clear(uint8_t *ssd, uint8_t ssd_size, RenderArea frame_area) {
